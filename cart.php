						...
						<div class="login-page">
							<div class="account_grid">
								<div class="col-md-6 login-left">
									 <h3>Shopping Cart</h3>
									 <p>By shopping with our store, you will be able to move through the checkout process faster, store multiple shipping addresses, view and track your orders in your account and more.</p>
									 <a class="acount-btn" href="services.php">View Products</a>
								</div>
