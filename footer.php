<div class="facebook-section">
					<div class="container">
					<div class="face-top">
						<h5><img src="images/facebook.png"></h5>
					</div>
					</div>
				</div>
				<div class="footer-section">
					<div class="container">
						<div class="footer-grids">
							...
							<div class="col-md-3 footer-grid">
								<h4>get in touch</h4>
								<p>V-86 Nehru Enclave</p>
								<p>Vishwas Khand, Gomtinagar</p>
								<p>Telephone : +1 234 567 890</p>
								<p>Telephone : +1 234 567 890</p>
								<p>FAX : + 1 234 567 890</p>
								<p>E-mail : <a href="mailto:cedhosting@cedhost.com"> cedhosting@mail.com</a></p>
							</div>
							<div class="clearfix"></div>
						</div>
